...
void addToPlaylist(SONG* playlist[], SONG songs[], int* playlistCount, int songIndex);
void showPlaylist(SONG* playlist[], int playlistCount);
float totalPlaytime(SONG* playlist[], int playlistCount);
